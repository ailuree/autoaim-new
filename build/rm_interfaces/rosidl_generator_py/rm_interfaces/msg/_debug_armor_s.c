...
bool rm_interfaces__msg__debug_armor__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("rm_interfaces.msg._debug_armor.DebugArmor", full_classname_dest, 41) == 0);
  }
  rm_interfaces__msg__DebugArmor * ros_message = _ros_message;
  {  // center_x
...
PyObject * rm_interfaces__msg__debug_armor__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("rm_interfaces.msg._debug_armor");
