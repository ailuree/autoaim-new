...
#define NODE_MAIN_LOGGER_NAME "rune_solver_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "librune_solver.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<fyt::rune::RuneSolverNode>";
